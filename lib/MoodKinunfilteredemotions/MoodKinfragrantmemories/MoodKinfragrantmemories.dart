...
import '../../MoodKinwholesomeinteraction/MoodKinporcelainheartsutterflies/MoodKinporcelainheartsutterflies.dart';
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            FutureBuilder(
                            future: MoodKinTenderUnderstanding
                      .MoodKinReflectiveListener('quiveringHonesty.png'),      
                              builder: (context, asyncSnapshot) {
                                if (!asyncSnapshot.hasData) return const SizedBox(); 
                                return Container(
                                  width: double.infinity,
                            ...
                            Builder(
                              builder: (context) {
                                if (vortexSpectrum != null &&
                                  ...
                                  return InkWell(
                                    onTap: () async {
                                      final currentIndex = genuineSynapseLocus()
                                          .emotionalSupportT;
                                    ...
                                    child: FutureBuilder(
                                       future: MoodKinTenderUnderstanding
                      .MoodKinReflectiveListener('resonanceZenKoanOperaAria.png'), 
                                      builder: (context, asyncSnapshot) {
                                        if (!asyncSnapshot.hasData) return const SizedBox();     
                                        return Container(
                                          width: 305.0,
                                  ...
                                  return FutureBuilder(
                                     future: MoodKinTenderUnderstanding
                      .MoodKinReflectiveListener('moonlitConfidants.png'),    
                                    builder: (context, asyncSnapshot) {
                                      if (!asyncSnapshot.hasData) return const SizedBox();     
                                      return Container(
                                        width: 305.0,
