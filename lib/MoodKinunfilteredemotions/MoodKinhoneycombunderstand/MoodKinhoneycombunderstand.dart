                              ...
                              child: Builder(
                                builder: (context) {
                                  ...
                                  return ListView.separated(
                                    ...
                                    itemBuilder:
                                        (context, soulfulDialoguePodIndex) {
                                      final soulfulDialoguePodItem =
                                          soulfulDialoguePod[
                                              soulfulDialoguePodIndex];
                                      return Align(
                                        alignment:
                                            AlignmentDirectional(0.0, -1.0),
                                        child: Container(
