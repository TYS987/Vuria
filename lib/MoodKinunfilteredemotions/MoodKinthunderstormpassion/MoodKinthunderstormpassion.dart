                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Padding(
                          padding:
                              EdgeInsetsDirectional.fromSTEB(12, 54, 12, 0),
                          child: Row(
                            mainAxisSize: MainAxisSize.max,
                                                    ...
                                                    if (genuineSynapseLocus()
                                                      ...
                                                      return InkWell(
                                                        ...
                                                        child: FutureBuilder(
                                                            future: MoodKinTenderUnderstanding
                                                                .MoodKinReflectiveListener(
                                                                    'emotionEncryptionProtocolesn.png'),
                                                            builder: (context,
                                                                asyncSnapshot) {
                                                              if (!asyncSnapshot
                                                                  .hasData)
                                                                  ...
                                                                  if (sorrowSharedSanctuaryItem
                                                                    ...
                                                                    return InkWell(
                                                                      onTap:
                                                                          () async {
                                                                        genuineSynapseLocus()
                                                                            .removeFromVibeSynthesisModuleWL(sorrowSharedSanctuaryItem);
                                                                        genuineSynapseLocus()
                                                                            .update(() {});
                                                                      },
                                                                      child: FutureBuilder(
                                                                          ...
                                                                          builder:
                                                                            ...
                                                                            return GestureDetector(
                                                                              ...
                                                                              child: Padding(
                                                                                ...
                                                                                child: SteampunkConfidantWidget(
                                                                                  mutualFeelingBridgeID: sorrowSharedSanctuaryItem.friendshipBondingPortal,
                                                                                  sharedEmotionVortex: 1,
                                                                                ),
                                                                              ),
                                                                            );
