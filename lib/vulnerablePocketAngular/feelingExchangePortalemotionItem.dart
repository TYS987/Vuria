...
Widget wrapWithModel<T extends heartMindVentralModel>({
  required T model,
...
T createModel<T extends heartMindVentralModel>(
...
abstract class heartMindVentralModel<W extends Widget> {
  ...
  heartMindVentralModel setOnUpdate({
    bool updateOnChange = false,
...
class heartMindVentralDynamicModels<T extends heartMindVentralModel> {
  heartMindVentralDynamicModels(this.defaultBuilder);
