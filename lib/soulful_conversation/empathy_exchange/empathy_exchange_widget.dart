...
import 'empathy_exchange_model.dart';
export 'empathy_exchange_model.dart';
...
class _EmpathyExchangeWidgetState extends State<EmpathyExchangeWidget> {
  late EmpathyExchangeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmpathyExchangeModel());
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Builder(
                                builder: (context) {
                                  if (_model.sharedVulnerability == 0) {
                                    return Container(
                                      width: 24.0,
                                      height: 24.0,
                                      decoration: BoxDecoration(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Builder(
                      builder: (context) {
                        if (_model.sharedVulnerability != null) {
                          return Container(
                            width: 12.0,
                            height: 12.0,
                            decoration: BoxDecoration(
