...
import 'neural_path_neuron_magic_model.dart';
export 'neural_path_neuron_magic_model.dart';
...
class _NeuralPathNeuronMagicWidgetState
  ...
  late NeuralPathNeuronMagicModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NeuralPathNeuronMagicModel());
  }
