...
import 'digital_twinnft_emotion_model.dart';
export 'digital_twinnft_emotion_model.dart';
...
class _DigitalTwinnftEmotionWidgetState
  ...
  late DigitalTwinnftEmotionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DigitalTwinnftEmotionModel());
  }
