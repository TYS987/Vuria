...
import 'supportive_bonding_model.dart';
export 'supportive_bonding_model.dart';
...
class _SupportiveBondingWidgetState extends State<SupportiveBondingWidget> {
  late SupportiveBondingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SupportiveBondingModel());
  }
