...
import 'emotional_harmony_model.dart';
export 'emotional_harmony_model.dart';
...
class _EmotionalHarmonyWidgetState extends State<EmotionalHarmonyWidget> {
  late EmotionalHarmonyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EmotionalHarmonyModel());
  }
