                    ...
                    child: Column(
                      ...
                      children: [
                        Padding(
                          ...
                          child: FutureBuilder(
                         future: MoodKinTenderUnderstanding
                      .MoodKinReflectiveListener('heartfeltConfessions.png'), 
                            builder: (context, asyncSnapshot) {
                              if (!asyncSnapshot.hasData) return const SizedBox();       
                              return Container(
                                width: 181.0,
                        ...
                        FutureBuilder(
                            future: MoodKinTenderUnderstanding
                      .MoodKinReflectiveListener('unspokenFeelings.png'), 
                          builder: (context, asyncSnapshot) {
                            if (!asyncSnapshot.hasData) return const SizedBox();   
                            return Container(
                              width: double.infinity,
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: FutureBuilder(
                                future: MoodKinTenderUnderstanding
                      .MoodKinReflectiveListener('gentleUnderstanding.png'),   
                              builder: (context, asyncSnapshot) {
                                if (!asyncSnapshot.hasData) return const SizedBox();   
                                return Container(
                                  width: 112.0,
                                ...
                                return Column(
                                  ...
                                  children: [
                                    Align(
                                      ...
                                      child: FutureBuilder(
                                        future: MoodKinTenderUnderstanding
                      .MoodKinReflectiveListener('embracedSilences.png'),  
                                        builder: (context, asyncSnapshot) {
                                          if (!asyncSnapshot.hasData) return const SizedBox();      
                                          return Container(
                                            width: 154.0,
