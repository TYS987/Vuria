...
import 'watercolor_emotions_ai_model.dart';
export 'watercolor_emotions_ai_model.dart';
...
class _WatercolorEmotionsAiWidgetState
  ...
  late WatercolorEmotionsAiModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WatercolorEmotionsAiModel());
