...
import 'synapse_serenitymes_model.dart';
export 'synapse_serenitymes_model.dart';
...
class _SynapseSerenitymesWidgetState extends State<SynapseSerenitymesWidget> {
  late SynapseSerenitymesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SynapseSerenitymesModel());
                      ...
                      InkWell(
                        ...
                        onTap: () async {
                          FFAppState().updateSteamPunkSiribleDroneRAtIndex(
                            ...
                            (e) => e
                              ...
                              ..cavePaintingNeuralinkSID =
                                  FFAppState().emotionalSupportT
                              ..thundercloudedT = _model.textController.text
                          ...
                          FFAppState().addToSamuraiSocialMediapiratePodcast(
                            ...
                            gladiatorGoogleetflixT: _model.textController.text,
                          ));
                          FFAppState().update(() {});
                        },
                        child: Container(
