...
import 'time_dilation_therapy_model.dart';
export 'time_dilation_therapy_model.dart';
...
class _TimeDilationTherapyWidgetState extends State<TimeDilationTherapyWidget> {
  late TimeDilationTherapyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TimeDilationTherapyModel());
