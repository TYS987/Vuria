...
import 'intimate_moments_share_model.dart';
export 'intimate_moments_share_model.dart';
...
class _IntimateMomentsShareWidgetState
  ...
  late IntimateMomentsShareModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IntimateMomentsShareModel());
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Builder(
                      builder: (context) {
                        if (_model.melancholyWhispers == 0) {
                          return Container(
                            width: 36.0,
                            height: 36.0,
                            decoration: BoxDecoration(
