...
import 'thunderstorm_passion_model.dart';
export 'thunderstorm_passion_model.dart';
...
class _ThunderstormPassionWidgetState extends State<ThunderstormPassionWidget> {
  late ThunderstormPassionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ThunderstormPassionModel());
