...
import 'fragrant_memories_model.dart';
export 'fragrant_memories_model.dart';
...
class _FragrantMemoriesWidgetState extends State<FragrantMemoriesWidget> {
  late FragrantMemoriesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FragrantMemoriesModel());
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Builder(
                        builder: (context) {
                          if (_model.serotoninDialogue != null) {
                            return Container(
                              width: 305.0,
                              height: 64.0,
                              decoration: BoxDecoration(
