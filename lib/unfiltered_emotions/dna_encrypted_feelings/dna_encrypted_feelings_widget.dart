...
import 'dna_encrypted_feelings_model.dart';
export 'dna_encrypted_feelings_model.dart';
...
class _DnaEncryptedFeelingsWidgetState
  ...
  late DnaEncryptedFeelingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DnaEncryptedFeelingsModel());
  }
