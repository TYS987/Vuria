...
import 'neural_empathy_pulse_model.dart';
export 'neural_empathy_pulse_model.dart';
...
class _NeuralEmpathyPulseWidgetState extends State<NeuralEmpathyPulseWidget> {
  late NeuralEmpathyPulseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NeuralEmpathyPulseModel());
