...
import 'sentiment_aligned_model.dart';
export 'sentiment_aligned_model.dart';
...
class _SentimentAlignedWidgetState extends State<SentimentAlignedWidget> {
  late SentimentAlignedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SentimentAlignedModel());
  }
