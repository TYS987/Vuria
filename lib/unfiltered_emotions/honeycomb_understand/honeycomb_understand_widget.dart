...
import 'honeycomb_understand_model.dart';
export 'honeycomb_understand_model.dart';
...
class _HoneycombUnderstandWidgetState extends State<HoneycombUnderstandWidget> {
  late HoneycombUnderstandModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HoneycombUnderstandModel());
  }
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        image: DecorationImage(
                                          fit: BoxFit.cover,
                                          image: Image.asset(
                                            'assets/images/migratoryFeelings.png',
                                          ).image,
                                        ),
                                        borderRadius:
                        ...
                        child: Builder(
                          builder: (context) {
                            ...
                            return ListView.separated(
                              ...
                              itemCount: soulfulDialoguePod.length,
                              separatorBuilder: (_, __) =>
                                  SizedBox(height: 20.0),
                              itemBuilder: (context, soulfulDialoguePodIndex) {
                                final soulfulDialoguePodItem =
                                    soulfulDialoguePod[soulfulDialoguePodIndex];
                                return Align(
                                  alignment: AlignmentDirectional(0.0, -1.0),
                                  child: Container(
                                    width: 351.0,
                                              ...
                                              child: Container(
                                                ...
                                                decoration: BoxDecoration(
                                                  image: DecorationImage(
                                                    fit: BoxFit.cover,
                                                    image: Image.asset(
                                                      'assets/images/chlorophyllComfort.png',
                                                    ).image,
                                                  ),
                                                ),
                                              ),
